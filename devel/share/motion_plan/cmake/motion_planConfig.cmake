...
if("TRUE" STREQUAL "TRUE")
  set(motion_plan_SOURCE_PREFIX /home/aakash/subo_base/src/motion_plan)
  set(motion_plan_DEVEL_PREFIX /home/aakash/subo_base/devel)
  ...
  set(motion_plan_INSTALL_PREFIX /home/aakash/subo_base/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'aakash <aakash@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_plan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aakash/subo_base/src/motion_plan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/aakash/subo_base/devel/lib;/home/aakash/subo_base/devel/lib;/home/aakash/simulation_ws/devel/lib;/home/aakash/catkin_ws/devel/lib;/opt/ros/melodic/lib)
